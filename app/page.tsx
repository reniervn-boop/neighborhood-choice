    ...
    <div className="min-h-screen pb-24" style={{ backgroundColor: 'var(--background)' }}>
      ...
      <main className="max-w-lg mx-auto px-4 py-5">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          ...
          {/* Noticeboard + Newsletters — full-width combined tile */}
          <Link
            href="/noticeboard"
          ...
          >
            {/* Two icons stacked to signal both content types */}
            <div
            ...
            <div className="flex-1 min-w-0">
              <p className="font-extrabold text-gray-900 text-sm">Noticeboard &amp; Newsletters</p>
              <p className="text-gray-400 text-xs mt-0.5">Announcements · alerts · committee editions</p>
            </div>
